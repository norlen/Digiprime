...
router
	...
	.post(isLoggedIn, upload.array('image'), validateOffer, catchAsync(offers.create));
...
router
	...
	.put(isLoggedIn, isAuthor, upload.array('image'), validateOffer, catchAsync(offers.updateForm))
